...
\input{items/tech_proficientskills.tex}\\ 
{\large\textbf{ {Familiar with:}}\\}
\input{items/tech_familiarskills.tex}
...
\input{items/research_stays}

\begin{Section}
  {Talks and posters}
\end{Section}

\input{items/talks-posters}
